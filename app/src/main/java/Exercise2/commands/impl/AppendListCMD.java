...
public class AppendListCMD implements ICommand {
    final private IConsole console;
    private final IListable<Student> SingleList;
    private final IListable<Student> DoubleList;

    public AppendListCMD(IConsole console, IListable<Student> singleList, IListable<Student> doubleList) {
    ...
    public void execute() {
        ...
        System.out.println("The Student " + prename + " got appended to the list.");
    }
